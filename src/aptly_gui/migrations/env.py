...
from aptly_gui.db.models import Base
...
def run_migrations_online() -> None:
    # The application passes its own connection so the upgrade can run inside the
    # running event loop; the CLI passes none and gets its own engine.
